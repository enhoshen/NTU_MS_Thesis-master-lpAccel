...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        ...
        alex conv2     & 27 & 27 & 31 & 31 & 4   & 1  & 1  & 4  & 4  & 2  & 5  & 5  & 64 & 1  & 64  & 27 & 27 & 256 & 1         \\
...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        \begin{tabular}{l|llllllllllllllllllllll}
                & $T_w$ & $T_h$ & $H'$ & $W'$ & $P_{ch}$ & $X_b$ & $W_b$ & $A_b$ & $O_b$ & $P_m$ & $R$  & $S$  & $T_m$ & $T_b$ & $C$   & $E$  & $F$  & $M$   & psum word \\
        \toprule
            vgg1   & 16 & 16 & 18 & 18 & 4   & 2  & 1  & 4  & 4  & 4  & 3 & 3 & 64 & 2  & 3   & 224 & 224 & 64  & 2         \\
...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        \begin{tabular}{l|lllllllllllllllllll}
            ...
            alexnor conv2     & 27 & 27 & 31 & 31 & 4   & 1  & 1  & 1  & 1  & 2  & 5  & 5  & 64 & 1  & 64  & 27 & 27 & 256 & 1         \\
...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        ...
        alex conv2     & 496           & 400           & 54                & 67144       & 1.61                 & 6.91                \\
...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        \begin{tabular}{l|llllll}
               & ibuf size (B) & wbuf size (B) & psum pad (2B) & gb size (B) & off-chip access (MB) & prcessing time (ms) \\
        \toprule
        vgg1   & 288           & 288           & 128               & 80512       & 11.72                & 18.06               \\
...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        ...
        alexnor conv2 & 496           & 400           & 54                & 67144       & 0.40                 & 1.73                \\
...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        ...
        alexnet 8b conv2 & 496           & 400           & 54                & 67144       & 3.21                 & 13.82               \\
        alexnet 8b conv3 & 120           & 288           & 52                & 79008       & 1.97                 & 7.19                \\
        alexnet 8b conv4 & 120           & 288           & 52                & 79008       & 1.54                 & 5.39                \\
        alexnet 8b conv5 & 120           & 288           & 52                & 79008       & 1.15                 & 4.04                \\
        \midrule
                total      &               &               &                   &             & 10.56                & 34.78   \\
        \bottomrule
        \end{tabular}
...
\begin{table}[h]
    ...
    \resizebox{\linewidth}{!}{%
        ...
        TensorRT Alex 8-bit    & 115    & 0.035 & 10.56  & 573   & 57   \\
        \bottomrule
        \end{tabular}
    }
\end{table}
