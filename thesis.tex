...
\input{inc/3_low_numeric_convolution_neural_network/lp_NN.tex}
\input{inc/4_proposed_architecture/proposed_architecture.tex}
\input{inc/5_conclusion/conclusion.tex}
%syntax references
\input{reference.tex}
